    ...
    public static class DiffusionRodCengel
    {
        public static Model CreateModel()
        {
            ...
            model.BoundaryConditions.Add(new ConvectionDiffusionBoundaryConditionSet(
                new []
                {
                    //new NodalUnknownVariable(nodes[0], ConvectionDiffusionDof.UnknownVariable, 0d),
                    //new NodalUnknownVariable(nodes[2], ConvectionDiffusionDof.UnknownVariable, 200d)
